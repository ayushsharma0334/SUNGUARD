        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <address className="not-italic text-sm space-y-2 text-foreground/80">
              <p>Suncast Global Pvt. Ltd.</p>
              <p>Khasra No 119 Mahindra Road,</p>
              <p>Prithla Industrial Area, Palwal, Haryana, 121102, INDIA</p>
              <p>Phone (Mr. Sanjiv Aggarwal): <a href="tel:+919818482365" className="hover:text-primary hover:underline">+91 9818482365</a></p>
              <p>Phone (Mr. Satish Maheshwari): <a href="tel:+919811982501" className="hover:text-primary hover:underline">+919811982501</a></p>
